...
public class Delivery {
	...
	public Delivery(String lastName, String firstName, String company, String address, String city, String postalCode,
			String state, String telephone, Country country, Zone zone, String latitude, String longitude) {
		super();
		this.lastName = lastName;
		this.firstName = firstName;
		this.company = company;
